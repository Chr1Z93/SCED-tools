...
FILE_OR_FOLDER_PATH = r"C:\git\SCED-downloads\decomposed\campaign\Language Pack Spanish - Campaigns\LanguagePackSpanish-Campaigns.SpanishC\NotZ.f85885.json"
